...
--remove duplicates   show_id
select show_id,COUNT(*) 
from netflix_raw
group by show_id 
having COUNT(*)>1  -- after checking for duplicates in show_id coloumn this column is made as PK, this is done after dropping the table one more time then loading it again
